...
export default async function CollectorTasksPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-[var(--foreground)]">Available tasks</h1>
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <h3 className="truncate font-semibold text-[var(--foreground)]">{task.title}</h3>
                    {task.description && (
                  ...
                  <div className="text-right shrink-0">
                    <div className="text-xl font-bold text-[var(--collector)]">${task.bounty_amount}</div>
